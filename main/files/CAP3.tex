...
tarefas escolhidas dentro das funcionalidades da aplicação foram as apresentadas na Tabela \ref{tab:cenarios-de-uso}. 

\begin{table}[htbp]
    \centering
    \caption{Tarefas executadas no aplicativo BURI e suas descrições. Fonte: Autor, com base em \cite{ufam-design}.}\label{tab:cenarios-de-uso}
    \begin{tabular}{p{4cm}|p{10cm}}
    \toprule
