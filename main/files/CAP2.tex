...
No Android, a \textit{ViewModel} possui o papel de persistência dos dados quando ocorre mudança de estado na \textit{activity}, visto 
que o próprio \textit{Framework} disponibiliza uma classe com o mesmo nome. Isso ocorre porque os dados armazenados em variáveis ou componentes visuais são 
perdidos quando há mudança de estado, pois a tela principal irá passar novamente pelos estados definidos na seção anterior \cite{google-developers-viewmodel}. 
