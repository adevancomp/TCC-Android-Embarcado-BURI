...
%Com a vantagem de extensão dos sistemas web, um braço de desenvolvimento de software é a construção de 
%API's REST para comunicação entre sistemas. O padrão REST (Representational State Transfer) é um estilo de 
%arquitetura que fornece uma interface 
