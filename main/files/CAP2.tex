...
O Android é um Sistema Operacional de código aberto baseado na \textit{kernel} do Linux, com foco em dispositivos móveis, cujo 
projeto tem liderança da Google\textsuperscript{\textregistered}. Porém, o \textit{Android Open Source Project} (AOSP) é o repositório
de código aberto do Android, incluindo o código-fonte do SO e ferramentas necessárias para a criação de versões customizadas da plataforma, como 
, por exemplo, \textit{ROMs} personalizadas, que permitem aos desenvolvedores e fabricantes adaptar o sistema operacional 
às necessidades específicas de diferentes dispositivos e usuários. 
